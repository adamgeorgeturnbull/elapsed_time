...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 10:34:34 2019
...
df_off = pd.read_csv('offtask_gradient_similarity.csv')
df_on = pd.read_csv('ontask_gradient_similarity.csv')
df_es = pd.read_csv('elapsed_time_gradient_similarity.csv')

ax.scatter3D(df_off['Gradient1'], df_off['Gradient2'], df_off['Gradient3'], c='b', s=0.1)
ax.scatter3D(df_on['Gradient1'], df_on['Gradient2'], df_on['Gradient3'], c='r', s=0.1)
ax.scatter3D(df_es['Gradient1'], df_es['Gradient2'], df_es['Gradient3'], c='g', s=0.1)
...
rotanimate(ax, angles,'movie.mp4',fps=2,bitrate=2000)
